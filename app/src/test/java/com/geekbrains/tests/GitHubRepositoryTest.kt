...
class GitHubRepositoryTest {
    ...
    @Mock
    private lateinit var gitHubApi: ApiHolder
    ...
    fun searchGithub_Test() {
        ...
        `when`(gitHubApi.api.searchGithub(searchQuery)).thenReturn(call)
        repository.searchGithub(searchQuery, mock(RepositoryCallback::class.java))
        verify(gitHubApi.api, times(1)).searchGithub(searchQuery)
    }
