...
class DetailsFragmentEspressoTest {
    ...
    fun fragment_testBundle() {
        ...
        onView(withId(R.id.detailsFragmentTextView)).check(assertion)
    }
    ...
    fun fragment_testIncrementButton() {
        ...
        onView(withId(R.id.detailsFragmentTextView)).check(matches(withText(TEST_NUMBER_OF_RESULTS_PLUS_1)))
    }
}